...
recommendations_bert4rec_alt_redis = Redis(app, config_prefix="REDIS_RECOMMENDATIONS_BERT4REC_ALT")
...
catalog.upload_recommendations(
    recommendations_bert4rec_alt_redis.connection,
    "RECOMMENDATIONS_BERT4REC_ALT_FILE_PATH",
    key_object="item_id",
    key_recommendations="recommendations",
)
bert4rec_alt_i2i_recommender = I2IRecommender(
    listen_history_redis.connection,
    recommendations_bert4rec_alt_redis.connection,
    random_recommender,
)
...
class NextTrack(Resource):
    def post(self, user: int):
        ...
        if treatment == Treatment.C:
            ...
            recommender = bert4rec_alt_i2i_recommender
        else:
